...
#define BLTOUCH
#if ENABLED(BLTOUCH)
  #define SERVO0_PIN 27 // Pin 27 is for Z-Endstop on the Creality v1.1.5 board
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  // #define MIN_SOFTWARE_ENDSTOP_Z Allows Z to go negative (e.g., for probing below Z=0)
#endif
